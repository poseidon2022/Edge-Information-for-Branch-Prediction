...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_binary_search.cpp, i8* null }]
...
define dso_local i32 @_Z12binarySearchPiiii(i32* %0, i32 %1, i32 %2, i32 %3) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %11 = call i32 @_Z12binarySearchPiiii(i32* %7, i32 0, i32 %9, i32 %10)
  store i32 %11, i32* %5, align 4
  %12 = load i32, i32* %5, align 4
  %13 = icmp ne i32 %12, -1
  %14 = zext i1 %13 to i64
  %15 = select i1 %13, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0)
