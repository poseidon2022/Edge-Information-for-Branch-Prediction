...
define dso_local i32 @main() #5 {
  ...
  store %struct.Node* %8, %struct.Node** %12, align 8
  %13 = call i8* @_Znwm(i64 16) #7
  ...
  %16 = getelementptr inbounds %struct.Node, %struct.Node* %14, i32 0, i32 1
  ...
  store %struct.Node* %14, %struct.Node** %20, align 8
  %21 = load %struct.Node*, %struct.Node** %2, align 8
  call void @_Z9printListP4Node(%struct.Node* %21)
  ret i32 0
}
