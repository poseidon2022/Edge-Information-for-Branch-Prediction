...
@.str = private unnamed_addr constant [6 x i8] c"Prime\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"Not Prime\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_prime.cpp, i8* null }]
...
define dso_local zeroext i1 @_Z7isPrimei(i32 %0) #4 {
  %2 = alloca i1, align 1
...
define dso_local i32 @main() #5 {
  ...
  %4 = call zeroext i1 @_Z7isPrimei(i32 %3)
  %5 = zext i1 %4 to i64
  %6 = select i1 %4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_prime.cpp() #0 section ".text.startup" {
