...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_sorting.cpp, i8* null }]
...
define dso_local zeroext i1 @_Z12linearSearchPiii(i32* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i1, align 1
...
define dso_local i32 @main() #5 {
  ...
  %9 = call zeroext i1 @_Z12linearSearchPiii(i32* %6, i32 %7, i32 %8)
  %10 = zext i1 %9 to i64
  %11 = select i1 %9, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_sorting.cpp() #0 section ".text.startup" {
